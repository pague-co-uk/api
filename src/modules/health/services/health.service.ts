...
import type {
  HealthIndicator,
} from "../indicators/health-indicator.interface.js";
...
} from "../indicators/applications-health.indicator.js";

import {
  DatabaseHealthIndicator,
} from "../indicators/database-health.indicator.js";

import {
  RabbitMqHealthIndicator,
} from "../indicators/rabbitmq-health.indicator.js";
...
export class HealthService {
  ...
  constructor(
    ...
    private readonly applications: ApplicationsHealthIndicator,
  ) { }
  ...
  public async platformCheck(): Promise<HealthResponse> {
    const start =
      performance.now();
